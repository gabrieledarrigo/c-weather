...
all: main get_weather_data parse_json read_file search_city
	gcc -Wall bin/main.o bin/read_file.o bin/get_weather_data.o bin/parse_json.o bin/search_city.o -lcurl lib/libjsmn.a -o weather
